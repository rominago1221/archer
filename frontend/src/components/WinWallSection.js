...
const D = {
  us: {
    ...
    carousel: [
      { initials: 'MR', name: 'Mike R.', meta: 'Austin, TX \u00B7 Insurance denial', amount: '$14,500', title: ['Insurance refused to pay $14,500. ', 'They paid it in full.'], desc: "Archer cross-checked Mike\u2019s water damage policy and found the exclusion clause they cited didn\u2019t apply to his contract. The insurer reversed the denial within 6 days." },
      { initials: 'TJ', name: 'Tyler J.', meta: 'Phoenix, AZ \u00B7 Speeding ticket', amount: '$1,200', title: ['Caught at 92 mph. ', 'License saved. Ticket dismissed.'], desc: 'Tyler was facing a reckless driving charge and a $1,200 fine. Archer spotted a calibration discrepancy in the radar certification log. The judge dismissed the case at first hearing.' },
      { initials: 'JM', name: 'Jessica M.', meta: 'Houston, TX \u00B7 Eviction notice', amount: '$3,800', title: ['They wanted me out in 30 days. Archer gave me ', '90 more days at home.'], desc: "Jessica\u2019s landlord sent a 30-day notice with three procedural violations under Texas tenant law. Archer spotted them in 47 seconds. The Attorney Letter went out before lunch." },
      { initials: 'AT', name: 'Ashley T.', meta: 'Los Angeles, CA \u00B7 Wrongful termination', amount: '$22,000', title: ['Fired without notice. Archer got me ', '$22,000 in severance.'], desc: 'Ashley was terminated after 6 years with no warning. Archer found a wrongful termination angle under California labor law. HR settled within 10 days of receiving the Attorney Letter.' },
      { initials: 'DK', name: 'David K.', meta: 'Chicago, IL \u00B7 Debt collection', amount: '$8,000', title: ['Debt collector for $8,000. ', 'Time-barred. Case closed.'], desc: 'David was being chased for a credit card debt from 2017. Archer proved it was beyond the statute of limitations under FDCPA. The collector dropped the claim immediately.' },
    ],
    ...
    wins: [
      { initials: 'RT', name: 'Rachel T.', meta: 'San Diego, CA \u00B7 1 week ago', cat: 'red', catLabel: 'MEDICAL BILL', quote: '\u201CHospital sent me a $9,400 surprise bill. Archer found violations of the No Surprises Act. Bill voided.\u201D', amount: '$9,400' },
      { initials: 'MS', name: 'Marcus S.', meta: 'Dallas, TX \u00B7 1 week ago', cat: 'amber', catLabel: 'SECURITY DEPOSIT', quote: '\u201CLandlord kept my $2,800 deposit for fake damages. Archer drafted the demand letter. Full refund in 5 days.\u201D', amount: '$2,800' },
      { initials: 'JL', name: 'Jennifer L.', meta: 'New York, NY \u00B7 2 weeks ago', cat: 'teal', catLabel: 'PARKING FINES', quote: "\u201C4 parking tickets in an unmarked zone. Archer proved the signage didn\u2019t comply with NYC code. All dismissed.\u201D", amount: '$520' },
      { initials: 'CH', name: 'Carlos H.', meta: 'Miami, FL \u00B7 2 weeks ago', cat: 'purple', catLabel: 'EMPLOYMENT', quote: '\u201CEmployer tried to enforce a 5-year non-compete. Archer proved it was unenforceable. Now I work where I want.\u201D', amount: '$18,000' },
      { initials: 'SP', name: 'Sarah P.', meta: 'Seattle, WA \u00B7 3 weeks ago', cat: 'pink', catLabel: 'RENT INCREASE', quote: '\u201CLandlord wanted +24% rent increase. Archer proved it violated the rent stabilization ordinance. Capped at 6%.\u201D', amount: '$5,400' },
      { initials: 'BW', name: 'Brandon W.', meta: 'Atlanta, GA \u00B7 3 weeks ago', cat: 'indigo', catLabel: 'CAR INSURANCE', quote: '\u201CInsurance lowered my accident claim by 50%. Archer found 3 violations of the unfair claims practice act. Full payout.\u201D', amount: '$7,200' },
    ],
    ...
    ctaDesc: 'Archer reads your document, cross-checks 2.4 million case laws, runs five reasoning passes, and finds the legal angles that win. Then a real partner attorney signs the letter that makes them stop.',
  ...
  'en-be': {
    ...
    featured: 'FEATURED WIN', saved: 'SAVED', won: 'WON',
    carousel: [
      { initials: 'SM', name: 'Sarah M.', meta: 'Brussels \u00B7 Eviction notice', amount: '\u20AC1,151', title: ['They wanted me out in 30 days. Archer gave me ', '90 more days at home.'], desc: "Sarah\u2019s landlord sent an eviction notice with three procedural violations under Belgian tenant law. Archer spotted them in 47 seconds. The Attorney Letter went out before lunch." },
      { initials: 'EL', name: 'Emma L.', meta: 'Antwerp \u00B7 Wrongful termination', amount: '\u20AC18,400', title: ['Fired after 8 years. Archer got me ', '\u20AC18,400 in severance.'], desc: "Emma was terminated without proper notice. Archer calculated her full severance under the Claeys formula and CCT 109. The HR department didn\u2019t even argue when the Attorney Letter arrived." },
      { initials: 'JR', name: 'Julien R.', meta: 'Charleroi \u00B7 Insurance denial', amount: '\u20AC12,000', title: ['Insurance refused \u20AC12,000 in damages. ', 'They paid in full.'], desc: "Julien\u2019s water damage claim was denied citing an exclusion clause. Archer cross-checked the policy and found the exclusion didn\u2019t apply to his contract version. The insurer reversed the decision within a week." },
      { initials: 'TD', name: 'Thomas D.', meta: 'Li\u00E8ge \u00B7 Speeding ticket', amount: '\u20AC890', title: ['Caught at 142 km/h. ', 'License saved. Fine cancelled.'], desc: 'Thomas was facing license suspension and a \u20AC890 fine. Archer spotted a calibration anomaly in the radar certificate that no one had noticed. The case was dismissed at the first hearing.' },
      { initials: 'AB', name: 'Antoine B.', meta: 'Mons \u00B7 Rent increase', amount: '\u20AC1,872', title: ['My landlord wanted +18% rent. ', 'Got it down to 2.4%.'], desc: 'Antoine received a rent increase notice that exceeded the legal indexation. Archer calculated the maximum allowed under Belgian law and drafted a formal contestation. The landlord conceded immediately.' },
    ],
    ...
    filters: ['All wins', 'Speeding ticket', 'Eviction', 'Employment', 'Insurance', 'Debt', 'Rent'],
    wins: [
      { initials: 'CV', name: 'Camille V.', meta: 'Ghent \u00B7 1 week ago', cat: 'cyan', catLabel: 'DEBT COLLECTION', quote: '\u201CCollector chasing me for an old debt. Archer proved it was time-barred. They dropped it instantly.\u201D', amount: '\u20AC2,150' },
      { initials: 'MK', name: 'Marc K.', meta: 'Namur \u00B7 1 week ago', cat: 'teal', catLabel: 'SPEEDING TICKET', quote: "\u201CGot flashed at 56 in a 50 zone. Archer found the speed sign was hidden by a tree. Charge dismissed.\u201D", amount: '\u20AC165' },
      { initials: 'NF', name: 'Nadia F.', meta: 'Brussels \u00B7 2 weeks ago', cat: 'amber', catLabel: 'UNFAIR DEPOSIT', quote: '\u201CLandlord kept my \u20AC1,800 deposit for fake damages. Archer drafted the contestation. Got it all back.\u201D', amount: '\u20AC1,800' },
      { initials: 'PD', name: 'Pierre D.', meta: 'Li\u00E8ge \u00B7 2 weeks ago', cat: 'purple', catLabel: 'EMPLOYMENT', quote: '\u201CEmployer tried to enforce a non-compete. Archer proved it was overly broad and unenforceable in Belgium.\u201D', amount: '\u20AC5,400' },
      { initials: 'LK', name: 'Laura K.', meta: 'Antwerp \u00B7 3 weeks ago', cat: 'indigo', catLabel: 'INSURANCE', quote: '\u201CCar insurance lowered my claim by 40%. Archer found 2 violations of consumer protection law. Full payout.\u201D', amount: '\u20AC3,650' },
      { initials: 'SB', name: 'Sophie B.', meta: 'Charleroi \u00B7 3 weeks ago', cat: 'pink', catLabel: 'PARKING FINE', quote: "\u201C3 parking fines in a no-sign zone. Archer found the signage was non-compliant. All cancelled.\u201D", amount: '\u20AC345' },
    ],
    loadMore: 'Load more wins', savedLabel: 'Saved',
  ...
  'fr-be': {
    ...
    carousel: [
      { initials: 'SM', name: 'Sarah M.', meta: 'Bruxelles \u00B7 Expulsion', amount: '1 151 \u20AC', title: ['Ils voulaient me mettre dehors en 30 jours. Archer m\u2019a donn\u00E9 ', '90 jours de plus chez moi.'], desc: "Le propri\u00E9taire de Sarah a envoy\u00E9 un avis d\u2019expulsion avec trois vices de proc\u00E9dure en droit locatif belge. Archer les a rep\u00E9r\u00E9s en 47 secondes. L\u2019Attorney Letter est partie avant midi." },
      { initials: 'EL', name: 'Emma L.', meta: 'Anvers \u00B7 Licenciement abusif', amount: '18 400 \u20AC', title: ['Licenci\u00E9e apr\u00E8s 8 ans. Archer m\u2019a obtenu ', '18 400 \u20AC d\u2019indemnit\u00E9s.'], desc: "Emma a \u00E9t\u00E9 licenci\u00E9e sans pr\u00E9avis correct. Archer a calcul\u00E9 ses indemnit\u00E9s compl\u00E8tes selon la formule Claeys et la CCT 109. Le service RH n\u2019a m\u00EAme pas contest\u00E9 \u00E0 la r\u00E9ception de l\u2019Attorney Letter." },
      { initials: 'JR', name: 'Julien R.', meta: 'Charleroi \u00B7 Refus d\u2019assurance', amount: '12 000 \u20AC', title: ['L\u2019assurance a refus\u00E9 12 000 \u20AC de dommages. ', 'Ils ont tout pay\u00E9.'], desc: "La demande de d\u00E9g\u00E2ts des eaux de Julien a \u00E9t\u00E9 refus\u00E9e en invoquant une clause d\u2019exclusion. Archer a v\u00E9rifi\u00E9 la police et trouv\u00E9 que l\u2019exclusion ne s\u2019appliquait pas \u00E0 sa version du contrat. L\u2019assureur a revers\u00E9 sa d\u00E9cision en une semaine." },
      { initials: 'TD', name: 'Thomas D.', meta: 'Li\u00E8ge \u00B7 Exc\u00E8s de vitesse', amount: '890 \u20AC', title: ['Flash\u00E9 \u00E0 142 km/h. ', 'Permis sauv\u00E9. Amende annul\u00E9e.'], desc: "Thomas risquait un retrait de permis et une amende de 890 \u20AC. Archer a rep\u00E9r\u00E9 une anomalie de calibrage dans le certificat radar que personne n\u2019avait remarqu\u00E9e. L\u2019affaire a \u00E9t\u00E9 class\u00E9e d\u00E8s la premi\u00E8re audience." },
      { initials: 'AB', name: 'Antoine B.', meta: 'Mons \u00B7 Augmentation de loyer', amount: '1 872 \u20AC', title: ['Mon propri\u00E9taire voulait +18% de loyer. ', 'R\u00E9duit \u00E0 2,4%.'], desc: "Antoine a re\u00E7u un avis d\u2019augmentation de loyer d\u00E9passant l\u2019indexation l\u00E9gale. Archer a calcul\u00E9 le maximum autoris\u00E9 par la loi belge et r\u00E9dig\u00E9 une contestation formelle. Le propri\u00E9taire a c\u00E9d\u00E9 imm\u00E9diatement." },
    ],
    ...
    wins: [
      { initials: 'CV', name: 'Camille V.', meta: 'Gand \u00B7 1 semaine', cat: 'cyan', catLabel: 'RECOUVREMENT DE DETTE', quote: '\u201CUn recouvreur me poursuivait pour une vieille dette. Archer a prouv\u00E9 qu\u2019elle \u00E9tait prescrite. Ils ont abandonn\u00E9 imm\u00E9diatement.\u201D', amount: '2 150 \u20AC' },
      { initials: 'MK', name: 'Marc K.', meta: 'Namur \u00B7 1 semaine', cat: 'teal', catLabel: 'EXC\u00C8S DE VITESSE', quote: '\u201CFlash\u00E9 \u00E0 56 dans une zone 50. Archer a trouv\u00E9 que le panneau \u00E9tait cach\u00E9 par un arbre. Amende annul\u00E9e.\u201D', amount: '165 \u20AC' },
      { initials: 'NF', name: 'Nadia F.', meta: 'Bruxelles \u00B7 2 semaines', cat: 'amber', catLabel: 'CAUTION INJUSTIFI\u00C9E', quote: '\u201CMon propri\u00E9taire a gard\u00E9 mes 1 800 \u20AC de caution pour de faux d\u00E9g\u00E2ts. Archer a r\u00E9dig\u00E9 la contestation. Tout r\u00E9cup\u00E9r\u00E9.\u201D', amount: '1 800 \u20AC' },
      { initials: 'PD', name: 'Pierre D.', meta: 'Li\u00E8ge \u00B7 2 semaines', cat: 'purple', catLabel: 'EMPLOI', quote: '\u201CMon employeur a voulu imposer une clause de non-concurrence. Archer a prouv\u00E9 qu\u2019elle \u00E9tait trop large et inapplicable en Belgique.\u201D', amount: '5 400 \u20AC' },
      { initials: 'LK', name: 'Laura K.', meta: 'Anvers \u00B7 3 semaines', cat: 'indigo', catLabel: 'ASSURANCE', quote: '\u201CMon assurance auto a r\u00E9duit mon indemnisation de 40%. Archer a trouv\u00E9 2 violations du droit de la consommation. Indemnisation compl\u00E8te.\u201D', amount: '3 650 \u20AC' },
      { initials: 'SB', name: 'Sophie B.', meta: 'Charleroi \u00B7 3 semaines', cat: 'pink', catLabel: 'AMENDE DE STATIONNEMENT', quote: '\u201C3 amendes de stationnement dans une zone sans panneau. Archer a prouv\u00E9 que la signalisation n\u2019\u00E9tait pas conforme. Tout annul\u00E9.\u201D', amount: '345 \u20AC' },
    ],
    ...
    ctaDesc: "Archer lit votre document, croise 2,4 millions de jurisprudences, ex\u00E9cute cinq passes de raisonnement, et trouve les angles juridiques qui gagnent. Ensuite un vrai avocat partenaire signe la lettre qui les fait s\u2019arr\u00EAter.",
