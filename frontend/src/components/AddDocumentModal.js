...
const T = {
  en: {
    ...
    contextLabel: 'Add context for James (optional)',
  ...
  fr: {
    ...
    contextLabel: 'Ajoutez du contexte pour James (optionnel)',
  ...
  nl: {
    ...
    formats: 'PDF, Word, JPEG/PNG, scan — max 20 MB',
    contextLabel: 'Voeg context toe voor James (optioneel)',
