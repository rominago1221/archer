...
const T = {
  en: {
    ...
    opt1Desc: (authority) => `James drafts the complete letter. You sign it and send it yourself to ${authority || 'the recipient'}.`,
    opt1Btn: 'Generate my letter',
    divider: 'or for more impact',
    opt2Badge: 'Recommended',
    opt2Title: 'Letter signed by partner attorney',
    opt2Desc: 'James drafts the letter. A licensed partner attorney reviews it, signs it with their official bar number, and sends it on law firm letterhead.',
  ...
  fr: {
    ...
    opt1Desc: (authority) => `James rédige la lettre complète. Vous la signez et l'envoyez vous-même${authority ? ` au ${authority}` : ''}.`,
    ...
    opt2Desc: 'James rédige la lettre. Un avocat partenaire agréé la révise, la signe avec son numéro de barreau officiel, et l\'envoie sous en-tête de cabinet.',
  ...
  nl: {
    ...
    opt1Desc: (authority) => `James stelt de volledige brief op. U ondertekent en verstuurt deze zelf${authority ? ` naar ${authority}` : ''}.`,
    ...
    opt2Desc: 'James stelt de brief op. Een erkende partneradvocaat herziet, ondertekent met officieel balienummer en verstuurt op briefhoofd van kantoor.',
