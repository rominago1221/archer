const translations = {
  ...
  'ae-en': {
    ...
    nav: { howItWorks: 'How it works', attorneys: 'Attorneys', pricing: 'Pricing', faq: 'FAQ', signIn: 'Sign in', getStarted: 'Get started' },
    hero: {
      badge: 'Trusted by 3,500+ UAE residents',
      h1: ['Your lawyer,', 'without the', 'lawyer fees.'],
      sub: 'Got a legal problem? Upload your document. Jasper analyzes your risk in 60 seconds, tells you <strong>exactly what to do</strong> — and connects you to a real attorney only when you need one.',
      cta: 'Analyze my document — free',
      ctaLawyer: 'Talk to a lawyer now',
      footnote: 'No credit card · 60 seconds · Licensed UAE attorneys on demand',
      riskLabel: 'Your Risk Score',
      riskAction: 'Act within 7 days',
      availableNow: '3 attorneys available now',
    },
    ...
    stats: {
      docs: '8,142', docsLabel: 'Documents analyzed',
      users: '3,517', usersLabel: 'UAE residents protected',
      saved: 'AED 12M', savedLabel: 'Legal fees saved',
      rating: '4.9/5', ratingLabel: 'Average rating',
    },
    trust: ['Licensed UAE attorneys', 'Results in 60 seconds', '256-bit encryption', 'Attorney-reviewed AI', 'No hidden fees'],
    press: 'As seen in',
    categories: {
      sectionLabel: 'What Jasper handles',
      h2: 'Whatever your legal problem — Jasper handles it.',
      sub: 'From employment contracts to tenancy disputes, visa issues to business formation — Jasper covers every common legal situation UAE residents face.',
      items: [
        { title: 'Employment contracts', desc: 'Unfair termination, end-of-service gratuity, non-compete clauses under UAE Labour Law.', badge: 'Most common', badgeClass: 'badge-blue' },
        { title: 'Tenancy disputes', desc: 'RERA regulations, rental increases, deposit recovery, eviction notices.', badge: 'Very common', badgeClass: 'badge-green' },
        { title: 'Business formation', desc: 'Free zone vs mainland, trade licenses, MOA review, shareholder agreements.', badge: 'B2B', badgeClass: 'badge-blue' },
        { title: 'Visa & immigration', desc: 'Employment visa, golden visa, sponsor obligations, residency cancellation.', badge: 'Expats', badgeClass: 'badge-blue' },
        { title: 'Debt & bounced cheques', desc: 'Debt recovery, cheque disputes under new Penal Code, instalment plans.', badge: 'Urgent', badgeClass: 'badge-red' },
        { title: 'Consumer protection', desc: 'Defective goods, service complaints, e-commerce disputes, refund claims.', badge: 'Common', badgeClass: 'badge-green' },
        { title: 'Real estate', desc: 'SPA review, off-plan disputes, developer obligations, RERA complaints.', badge: 'High value', badgeClass: 'badge-red' },
        { title: 'Family law', desc: 'Divorce under UAE Personal Status Law, custody, prenuptial agreements.', badge: 'Sensitive', badgeClass: 'badge-gray' },
        { title: 'Criminal matters', desc: 'Cybercrime, defamation, police complaints — know your rights before acting.', badge: 'Time-sensitive', badgeClass: 'badge-red' },
      ],
    },
    problem: {
      label: 'The problem',
      h2: 'Legal help used to cost AED 2,000 just to ask a question.',
      p: "You received a demand letter. A contract you don't understand. A RERA notice. You're stressed — and a real lawyer costs AED 1,500/hr just to pick up the phone. Jasper changes that.",
      steps: ['Upload your document in seconds', 'Get your Risk Score instantly', 'Know exactly what to do next', 'Talk to a real lawyer for AED 549 — not AED 1,500/hr'],
      mockFile: 'employment_contract.pdf uploaded',
      mockAnalyzing: 'Analyzing in 60 seconds...',
      mockScore: '78 / 100 — High Risk',
      mockAction: 'Respond within 10 days',
      mockFindings: ['Clause 3.2 violates UAE Labour Law Art. 46', 'Financial exposure up to AED 31,000', 'Strong case for negotiation'],
    },
    howItWorks: {
      label: 'How it works',
      h2: 'From confused to confident — in 4 steps',
      steps: [
        ...
        { title: 'Get your Risk Score', desc: 'Score from 0–100. Plain English. No jargon. In 60 seconds.' },
        { title: 'Your case stays alive', desc: 'Add docs as they arrive. Score updates. Next step always clear.' },
        { title: 'Talk to a lawyer', desc: 'AED 549 for 30 min. Attorney pre-briefed. No time wasted.' },
      ],
    },
    lawyersCta: {
      badge: 'Attorneys available right now',
      h2: ['Talk to a real lawyer.', 'By video. Right now.'],
      p: "Don't wait days for an appointment. Connect to a licensed UAE attorney in minutes — pre-briefed with your full case. 30 minutes, flat fee, no surprises.",
      cta: 'Book a video call — AED 549',
      footnote: 'Available same day · All Emirates · Licensed & vetted',
      availableNow: 'Available now',
      availableIn: 'Available in',
    },
    lawyersSection: { label: 'Our attorneys', h2: 'Real lawyers. Vetted. Ready.' },
    pricing: {
      label: 'Pricing',
      h2: 'Lawyer-level help. Not lawyer-level prices.',
      free: { name: 'Free', price: 'AED 0', period: 'forever', cta: 'Start for free', features: ['1 free document analysis', 'Risk Score overview'], disabled: ['Full risk report', 'Live case file', 'Attorney access'] },
      pro: { name: 'Pro', price: 'AED 249', period: 'per month', cta: 'Get started', badge: 'Most popular', features: ['Unlimited analyses', 'Full risk reports', 'Live case file', 'Dynamic Risk Score', 'Priority support'] },
      attorney: { name: 'Attorney call', price: 'AED 549', period: 'per session', cta: 'Book a call', features: ['30-min video call', 'Licensed UAE attorney', 'Pre-briefed by Jasper AI', 'Written follow-up', 'Same-day availability'] },
    },
    reviews: {
      label: 'Reviews',
      h2: 'Real people. Real results.',
      items: [
        { text: '"My employer terminated me unfairly. Jasper identified 3 Labour Law violations and I got my full gratuity. The attorney call was worth every dirham."', name: 'Ahmed K.', loc: 'Dubai, UAE' },
        { text: '"Landlord tried to raise my rent by 40%. Jasper showed me the RERA calculator and drafted a dispute letter. Problem solved in 48 hours."', name: 'Priya S.', loc: 'Abu Dhabi, UAE' },
        { text: '"Bounced cheque issue from an old business deal. Jasper explained the new decriminalization law and saved me from unnecessary panic."', name: 'Omar M.', loc: 'Sharjah, UAE' },
      ],
    },
    faq: {
      label: 'FAQ',
      ...
      items: [
        { q: 'Is Jasper giving me real legal advice?', a: 'Jasper provides legal information and document analysis — not legal advice. When you need actual legal advice, Jasper connects you to a licensed attorney.' },
        { q: 'Is my document secure?', a: 'All documents are encrypted with 256-bit encryption in transit and at rest. We never share your documents with third parties. You can delete your data anytime.' },
        { q: 'Who are the attorneys on Jasper?', a: 'All attorneys are licensed to practice in the UAE, with a minimum of 5 years of experience, and go through a rigorous vetting process.' },
        { q: 'Does Jasper understand UAE law?', a: 'Yes. Jasper is trained on UAE Federal Laws, DIFC regulations, ADGM rules, RERA guidelines, and local Emirate-level legislation.' },
        { q: 'How accurate is the Risk Score?', a: 'The Risk Score is generated by AI trained on thousands of legal documents and validated by licensed attorneys. It is a guidance tool to help you understand urgency and complexity.' },
        { q: 'Can I cancel my subscription anytime?', a: 'Yes. Cancel anytime with one click. No questions asked, no cancellation fees. Your case files remain accessible until the end of your billing period.' },
      ],
    },
    finalCta: {
      h2: ['Your lawyer, without', 'the lawyer fees.'],
      p: 'Join 3,500+ UAE residents who use Jasper to protect themselves — for less.',
      cta: 'Analyze my document — it\'s free',
    },
    footer: 'Jasper provides legal information and document analysis, not legal advice. Attorney consultations are conducted by independent, licensed legal professionals. Jasper does not create an attorney-client relationship.',
    lawyers: [
      { name: 'Fatima Al Mazrouei', specialty: 'Employment Law', bar: 'Dubai Bar', years: 11, tags: ['Labour disputes', 'Gratuity'], rating: 5.0, sessions: 178, status: 'now', photo: 'https://images.unsplash.com/photo-1573496359142-b8d87734a5a2?w=200&h=200&fit=crop' },
      { name: 'Raj Patel', specialty: 'Real Estate & RERA', bar: 'Abu Dhabi Bar', years: 8, tags: ['Tenancy', 'Off-plan'], rating: 4.9, sessions: 143, status: '12 min', photo: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=200&h=200&fit=crop' },
      { name: 'Khalid Al Rashid', specialty: 'Business & Corporate', bar: 'DIFC Courts', years: 14, tags: ['Company formation', 'Commercial'], rating: 4.9, sessions: 201, status: '5 min', photo: 'https://images.unsplash.com/photo-1472099645785-5658abf4ff4e?w=200&h=200&fit=crop' },
    ],
  },
...
export const LOCALE_OPTIONS = [
  ...
  { key: 'ae-en', flag: '\u{1F1E6}\u{1F1EA}', label: 'United Arab Emirates', sublabel: 'English' },
