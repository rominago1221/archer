  ...
  return (
    <div className="min-h-screen bg-[#fafafa] flex items-center justify-center p-4" data-testid="login-page">
      <div className="w-full max-w-md">
        {/* Brand header — centered logo + taglines */}
        <div style={{ textAlign: 'center', marginBottom: 32 }}>
          ...
          <p style={{ fontSize: 12, color: '#9ca3af', marginTop: 8, textAlign: 'center' }}>
            Law firm in your pocket.
          </p>
          <p style={{ fontSize: 12, color: '#6b7280', marginTop: 2, textAlign: 'center' }}>
        ...
        <div className="bg-white border border-[#ebebeb] rounded-2xl p-6">
          {!accountType ? (
            ...
            <div data-testid="login-form">
              ...
              <h2 className="text-[15px] font-semibold text-[#111827] mb-1">Client sign in</h2>
              <p className="text-[11px] text-[#6b7280] mb-5">Access your cases and documents</p>
